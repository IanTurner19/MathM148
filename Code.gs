// FILE ID OF data.csv, const FILE_ID = "1r5-JrKlNk8KGfYDPL6ZxfiTjrUFyUhjg";
...
function findFileId(){
  let files = DriveApp.getFilesByName("new_data.csv");
  while (files.hasNext()) {
 ...
 * e.parameter.fileId contains file id of output file
...
function doPost(e) {
  ...
  let file = DriveApp.getFileById(e.parameter.fileId);
  // 2. read its contents
